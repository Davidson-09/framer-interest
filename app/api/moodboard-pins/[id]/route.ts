...
// Get all pins for a moodboard by name and email
export async function GET(
  ...
  try {
    ...
    const moodboardName = params.id; // Using the id parameter as the moodboard name

    console.log(`API Request: GET /api/moodboard-pins/${moodboardName}?email=${email}`);
